...
function ShoppingCart() {
  ...
  if (products.length < 1) {
    return (
      <div className={styles.noProduct}>
        <p>장바구니에 상품이 없습니다</p>
        <Link to="/">
          <Button variant="primary">담으러 가기</Button>
        </Link>
      </div>
    );
  }
  ...
  return (
    <>
        ...
        <div className={styles.productList}>
          <div className={styles.productCards}>
            {products.map((product) => (
              <ItemCard product={product} key={product.title} />
            ))}
          </div>
      ...
      <div
        className={
          (isDarkMode ? styles.App_dark : styles.App_light) +
          " " +
          styles.modalBg +
      ...
      >
        <div className={styles.modal}>
          ...
          <div className={styles.modalBtnBox}>
            <Button variant="primary" onClick={closeModalAndDelete}>
              네
            </Button>
